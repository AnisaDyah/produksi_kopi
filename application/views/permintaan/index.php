        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
              <a href="<?php echo site_url('Permintaan/create'); ?>" type="button" class="btn btn-success">
                <i class="fa fa-plus"> Tambah Data Permintaan</i>
              </a>
            </div>
            <?php endif;?>
          </div>
            ...
            <table class="table table-striped table-bordered" id="tabeluser">
              ...
              <?php foreach ($list as $key): ?>
                <tr>
                  ...
                  <?php echo form_open('Permintaan/destroy/'.$key->id_permintaan)  ?>
                    <a href="<?php echo site_url('Permintaan/edit/'.$key->id_permintaan); ?>" title="Edit Nama Kategori" class="btn btn-primary">
