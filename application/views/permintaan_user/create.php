    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php echo site_url('permintaan_user/store') ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="form-group">
              <a class="btn btn-info" href="<?php echo base_url() ?>permintaan_user">Kembali</a>
